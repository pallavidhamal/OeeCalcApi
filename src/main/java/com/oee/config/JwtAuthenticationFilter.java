 ...
 * 
 * import com.oee.security.JwtService;
 * 
 ...
 * userDetailsService) { this.jwtService = jwtService; this.userDetailsService =
 * userDetailsService; }
 * 
 ...
 * 
 * final String jwt = authHeader.substring(7); final String userName =
 * jwtService.extractUserName(jwt);
 * 
 * Authentication authentication =
 * SecurityContextHolder.getContext().getAuthentication();
 * 
 * if(userName !=null && authentication == null) { //Authenticate UserDetails
