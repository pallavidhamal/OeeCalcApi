...
public interface SetUpRepository  extends JpaRepository<SetUpEntity, String> {
  ...
  boolean existsByUnitentityAndWorkcenterentityAndItementityAndStationentityAndNameAndIdNot
  (UnitEntity unitentity,WorkcenterEntity workcenterentity,ItemEntity itementity,StationEntity stationentity,String name,String id);
